      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-12 mb-8">
          ...
          <div className="space-y-4">
            ...
            >
              Hafiz<span className="text-accent-light">.</span>
            </motion.h3>
            <p className="text-white/80 leading-relaxed">
              System Developer & Backend Engineer building reliable, high-performance systems 
            ...
            <ul className="space-y-2">
              {footerLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-white/70 hover:text-white transition-colors inline-block hover:translate-x-1 transform duration-200"
                  >
                    {link.label}
                  </a>
                </li>
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-white/70 text-sm">
            <p>
              © {currentYear} Hafizul Rahman. All rights reserved.
            </p>
            <p>
